...
import com.example.captainhumza.fypversion2.DirectionsJSONParser;
...
public class MapDirections extends FragmentActivity {
    ...
    //  map = fm.getMapAsync((OnMapReadyCallback) getApplicationContext());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //getMenuInflater().inflate(R.menu.activity_map_directions, menu);
        return true;
    }
}