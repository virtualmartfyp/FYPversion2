package com.example.captainhumza.fypversion2.Rider;
...
import com.example.captainhumza.fypversion2.Vendor.CustomerListforVendor;
...
public class RiderHomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = new Intent (this , CustomerListforVendor.class);
            startActivity(intent);
        } else if (id == R.id.nav_gallery) {

            Intent intent = new Intent(this , WalletforRider.class);
            startActivity(intent);
