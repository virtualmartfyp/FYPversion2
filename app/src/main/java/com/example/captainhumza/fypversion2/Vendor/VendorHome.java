...
public class VendorHome extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent iten = new Intent( this , OrderdList.class);
            startActivity(iten);
        } else if (id == R.id.nav_gallery) {
            Intent intent = new Intent(this, RiderDetailsforVendor.class);
            ...
            Intent intent = new Intent(this , WalletforVendor.class);
            startActivity(intent);
